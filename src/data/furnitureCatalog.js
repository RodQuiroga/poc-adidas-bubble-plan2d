...
export const FURNITURE_CATALOG = [
  ...
  { numero: '36', nombre: 'Panel gráfico de ícono (silueta/mano)', codigosHU: ['HU2365', 'HU2347'], aportaCapacidad: true, capacidadSku: 4, capacidadPiezas: 6 },
  ...
  { numero: '41', nombre: 'Panel gráfico de acción (silueta corredor)', codigosHU: ['HU5369'], aportaCapacidad: true, capacidadSku: 4, capacidadPiezas: 6 },
  ...
  { numero: '43', nombre: 'Panel artístico + figura con dispositivo', codigosHU: ['HU2366', 'HU2353', 'HU3262'], aportaCapacidad: true, capacidadSku: 5, capacidadPiezas: 7 },
  { numero: '44', nombre: 'Panel artístico con figura corredora', codigosHU: ['HU2366', 'HU2353', 'HU3262'], aportaCapacidad: true, capacidadSku: 5, capacidadPiezas: 7 },
  ...
  { numero: '47', nombre: 'Gráfica de piso (corredor) + banca', codigosHU: ['HU2366', 'HU2355', 'HU2343'], aportaCapacidad: true, capacidadSku: 5, capacidadPiezas: 7 },
  ...
  { numero: '50', nombre: 'Figura/cutout tipo embajador de marca', codigosHU: ['HU2367'], aportaCapacidad: true, capacidadSku: 4, capacidadPiezas: 6 },
  ...
  { numero: '53', nombre: 'Trío de pedestales cilíndricos', codigosHU: ['HU2371'], aportaCapacidad: true, capacidadSku: 6, capacidadPiezas: 9 },
  { numero: '54', nombre: 'Banca/otomana ovalada', codigosHU: ['HU2685', 'HU2684'], aportaCapacidad: true, capacidadSku: 4, capacidadPiezas: 6 },
  { numero: '55', nombre: 'Banca ovalada grande (zona footwear poles)', codigosHU: ['HU2689', 'HU2690'], aportaCapacidad: true, capacidadSku: 5, capacidadPiezas: 7 },
